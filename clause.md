...
二、第一条所指的行为，包括但不限于使用<a href="#" title="模块列表" style="text-decoration:none;">模块列表</a>内的功能。
...
八、针对被终止服务的用户或群，您有权利向 wsoul 或相关服务提供方协商，最终裁定权仍归 wsoul 所有。
...
四、部分含有 林汐 或其开发者形象的资源，以及 林汐 的人物设定等信息，未经 wsoul 许可禁止任何修改与再发布。

## 条款修改

一、wsoul 保留对本条款作出不定时修改的权利。

二、本使用条款是您与 wsoul 签署的使用协议的组成部分之一，请您仔细阅读。

三、wsoul 对本页面内容拥有最终解释权。
